...
public class MainActivity extends AppCompatActivity {
    ...
    private EditText bufferfield;   //Checkbox replaced by EditText
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bufferfield = (EditText) findViewById(R.id.buffer_field);
        mDataBtn = (Button) findViewById(R.id.data);
        ...
        if(ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED)
            ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION}, 1);*/ //No location access required


        mHandler = new Handler(Looper.getMainLooper()) {

            //Handle the main application loop, analyzing message code to identify whether it's an update
            //in which case to read a byte array, encoded in UTF-8, store it in a string
            //and display the string in the buffer TextView
            //Else, if the Message is about the connection status, update the status TextView
        ...
        if (mBTArrayAdapter == null) {
            ...
            //Data transmission part from the bufferfield: TO DO
            ...
            mDataBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mConnectedThread != null) //First check to make sure thread created
                        sendString = bufferfield.getText().toString();
    ...
    final BroadcastReceiver blReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            String action = intent.getAction(); //Redundant?
    ...
    private void listPairedDevices(){
        mBTArrayAdapter.clear();    //Second clear
